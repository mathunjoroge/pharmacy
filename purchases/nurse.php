...
<center><h4><i class="icon-plus-sign icon-large"></i> Register Patient</h4></center>
<hr>
...
<form action="nursereg.php" method="post">
...
<span>systolic </span><input type="text" style="width:265px; height:30px;"  name="sys"  /><br>
<span>diastolic </span><input type="text" style="width:265px; height:30px;"  name="dys"> <br>
<span>heart rate: </span><input type="text" style="width:265px; height:30px;" name="hr" ><br>
<h5>other information</h5>
<span>temperature: </span><input type  style="width:265px; height:30px;" name="temp"  /><br>
<span>breathing Rate: </span><input type="text" style="width:265px; height:30px;"  name="br" ><br>
...
<span>other comments: </span><textarea style="width:265px; height:50px;" name="oc" ></textarea><br>
