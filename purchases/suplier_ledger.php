...
echo 'Contact : '.$rowas['suplier_contact'].'<br>';
echo 'Contact person: '.$rowas['contact_person'].'<br>';
}
?>
...
<a rel="facebox" href="addsledger.php?invoice=<?php echo $_GET['cname']; ?>&amount=<?php echo $rowa['amount2']; ?>" style="margin-top: 10px;"><button class="btn btn-success"><i class="icon-plus-sign icon-large"></i> Add Payment</button></a><br><br>
