...
<div class="container" >
	<div class="contentheader" >
		...
		<form class="ui-widget" action="customerstatement.php" method="get"><center><strong>From : <input type="text" style="width: 223px; padding:14px;" name="d1" class="tcal" value="" /> To: <input type="text" style="width: 223px; padding:14px;" name="d2" class="tcal" value="" />
			select customer:
...
Purchases and payment summary from&nbsp;<?php $date = $_GET['d1'] ;
                $d11 = strtotime ( $date ) ;
                $d11 = date ( 'j/m/Y' , $d11 );
