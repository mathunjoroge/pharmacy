...
<?php include('navfixed.php');?>
	...
	<div class="span10">
	<a href="cashier.php"><button class="btn btn-success" id="back"><i class="icon-arrow-left"></i> New sale</button></a>

<div class="content" id="content">
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	<div style="width: 100%; height: 190px;" >
	<div style="width: 900px; float: left;">
	<center><div style="font:bold 25px 'Aleo';">M&C Pharmacy</div> cash
	Sales Receipt
	</center>
	<div>
	<?php
...
<div class="pull-right" style="margin-right:100px;">
		...
		</div><script type="text/javascript">document.getElementById('print').click(); setTimeout(function(){document.getElementById('back').click();}, 1000);</script>	
</div>
</div>
