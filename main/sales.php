...
<div class="container">
<a  href="index.php"><button class="btn btn-success btn-large" style="float: none;" ><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a><button class="btn btn-success btn-large" style="float: none;" >sales return</button></a>&nbsp;<?php
...
?>
    ...
    <option value="<?php echo $row['product_id']; ?>" data-qty="<?=$row['quantity'];?>" data-bpr="<?=$row['o_price']; ?>" data-pr="<?=$row['o_price']*$row['markup'];?>" data-exp="<?=$row['expirydate'];?>" data-batch="<?=$row['batch_no'];?>" data-maxdisc="<?=$row['maxdiscre'];?>" data-maxdiscpc="<?=$row['maxdiscpr'];?>">
        <?=$row['gen_name'];?> -
            <?=$row['product_code'];?>
    </option>
<?php endfor;?>
...
<td><input  name="qty" min="1" placeholder="in stock" autocomplete="off" style="width:5rem; height:auto; padding-top:auto; padding-bottom: 4px; margin-right: 4px; font-size:15px;" readonly /></td>

<input type="hidden" name="exp" placeholder="expiry" autocomplete="off" style="width: 68px; height:auto; " readonly />
...
<td>
<input type="number" name="pr" min="1" placeholder="price" id="fpr" step=".00001" style="width: 68px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px;"></td>
